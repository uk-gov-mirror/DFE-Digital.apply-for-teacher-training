Rails.application.routes.draw do
  ...
  namespace :support_interface, path: '/support' do
    ...
    scope path: '/applications/:application_form_id' do
      ...
      get '/reinstate-offer/:application_choice_id' => 'application_forms/application_choices#reinstate_offer', as: :application_form_reinstate_offer
      post '/reinstate-offer/:application_choice_id' => 'application_forms/application_choices#confirm_reinstate_offer'
    end
