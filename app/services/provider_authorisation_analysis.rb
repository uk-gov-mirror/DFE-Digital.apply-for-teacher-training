class ProviderAuthorisationAnalysis
  ...
  def initialize(permission:, auth:, application_choice:, course_option_id: nil)
    ...
    @training_provider = application_choice.current_course_option.course.provider
    @ratifying_provider = application_choice.current_course_option.course.accredited_provider
  ...
  def provider_user_associated_with_training_provider?
    @_is_training_provider_user ||= provider_user.providers.include?(application_choice.current_course_option.course.provider)
  end
