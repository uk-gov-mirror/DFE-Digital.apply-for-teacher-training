  ...
  class << self
    ...
    def for_vendor_api_docs(current_controller)
      [
        ...
        NavigationItem.new(t('page_titles.api_docs.vendor_api.usage'), api_docs_usage_path, is_active_action(current_controller, 'usage')),
        NavigationItem.new(t('page_titles.api_docs.vendor_api.reference'), api_docs_reference_path, is_active_action(current_controller, 'reference')),
        NavigationItem.new(t('page_titles.api_docs.vendor_api.release_notes'), api_docs_release_notes_path, is_active_action(current_controller, 'release_notes')),
        NavigationItem.new(t('page_titles.api_docs.vendor_api.lifecycle'), api_docs_lifecycle_path, is_active_action(current_controller, 'lifecycle')),
        NavigationItem.new(t('page_titles.api_docs.vendor_api.help'), api_docs_help_path, is_active_action(current_controller, 'help')),
      ]
    end
