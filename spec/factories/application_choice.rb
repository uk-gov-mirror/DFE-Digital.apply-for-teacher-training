  ...
  factory :application_choice do
    ...
    trait :with_scheduled_interview do
      ...
      after(:build) do |application_choice, _evaluator|
        ...
        application_choice.interviews << build(:interview, provider: application_choice.current_course_option.course.provider)
      end
    end
    ...
    trait :with_cancelled_interview do
      ...
      after(:build) do |application_choice, _evaluator|
        ...
        application_choice.interviews << build(:interview, :cancelled, provider: application_choice.current_course_option.course.provider)
      end
    end
