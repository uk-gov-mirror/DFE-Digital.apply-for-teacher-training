...
ActiveRecord::Schema.define(version: 2021_03_02_165110) do
  ...
  create_sequence "provider_user_notification_preferences_id_seq"
  ...
  create_table "provider_user_notification_preferences", force: :cascade do |t|
    t.bigint "provider_user_id", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["provider_user_id"], name: "index_provider_user_notification_preferences_on_provider_user_id"
  end
  ...
  add_foreign_key "provider_user_notification_preferences", "provider_users", on_delete: :cascade
